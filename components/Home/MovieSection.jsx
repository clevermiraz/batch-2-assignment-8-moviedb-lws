                    ...
                    <div id="trendingMovies" className="flex space-x-4 overflow-x-auto pb-4">
                        ...
                        <div className="flex-shrink-0 w-48 cursor-pointer hover:scale-105 transition-transform">
                            <a href="details.html">
                                ...
                                />
                                <div className="mt-2">
                                    <h3 className="text-light text-sm font-bold truncate">Gladiator II</h3>
                        ...
                        <div className="flex-shrink-0 w-48 cursor-pointer hover:scale-105 transition-transform">
                            <a href="details.html">
                                ...
                                />
                                <div className="mt-2">
                                    <h3 className="text-light text-sm font-bold truncate">Spellbound</h3>
                        ...
                        <div className="flex-shrink-0 w-48 cursor-pointer hover:scale-105 transition-transform">
                            <a href="details.html">
                                ...
                                />
                                <div className="mt-2">
                                    <h3 className="text-light text-sm font-bold truncate">The Piano Lesson</h3>
                                    <p className="text-primary text-xs">2024</p>
                                </div>
                            </a>
                        </div>
                        <div className="flex-shrink-0 w-48 cursor-pointer hover:scale-105 transition-transform">
                            <a href="details.html">
                                ...
                                />
                                <div className="mt-2">
                                    <h3 className="text-light text-sm font-bold truncate">We Live in Time</h3>
                                    <p className="text-primary text-xs">2023</p>
                                </div>
                            </a>
                        </div>
                        ...
                        <div className="flex-shrink-0 w-48 cursor-pointer hover:scale-105 transition-transform">
                            <a href="details.html">
                                ...
                                />
                                <div className="mt-2">
                                    <h3 className="text-light text-sm font-bold truncate">Deadpool & Wolverine</h3>
                                    <p className="text-primary text-xs">2024</p>
                                </div>
                            </a>
                        </div>
                        <div className="flex-shrink-0 w-48 cursor-pointer hover:scale-105 transition-transform">
                            <a href="details.html">
                                ...
                                />
                                <div className="mt-2">
                                    <h3 className="text-light text-sm font-bold truncate">The Wild Robot</h3>
                                    <p className="text-primary text-xs">2023</p>
                                </div>
                            </a>
                        </div>
                        <div className="flex-shrink-0 w-48 cursor-pointer hover:scale-105 transition-transform">
                            <a href="details.html">
                                ...
                                />
                                <div className="mt-2">
                                    <h3 className="text-light text-sm font-bold truncate">The Substance</h3>
                                    <p className="text-primary text-xs">2022</p>
                                </div>
                            </a>
                        </div>
                        <div className="flex-shrink-0 w-48 cursor-pointer hover:scale-105 transition-transform">
                            <a href="details.html">
                                ...
                                />
                                <div className="mt-2">
                                    <h3 className="text-light text-sm font-bold truncate">Alien: Romulus</h3>
                                    <p className="text-primary text-xs">2024</p>
                                </div>
                            </a>
                        </div>
                        ...
                        <div className="flex-shrink-0 w-48 cursor-pointer hover:scale-105 transition-transform">
                            <a href="details.html">
                                ...
                                />
                                <div className="mt-2">
                                    <h3 className="text-light text-sm font-bold truncate">Gladiator</h3>
                        ...
                        <div className="flex-shrink-0 w-48 cursor-pointer hover:scale-105 transition-transform">
                            <a href="details.html">
                                ...
                                />
                                <div className="mt-2">
                                    <h3 className="text-light text-sm font-bold truncate">Absolution</h3>
                                    <p className="text-primary text-xs">2021</p>
                                </div>
                            </a>
                        </div>
                        ...
                        <div className="flex-shrink-0 w-48 cursor-pointer hover:scale-105 transition-transform">
                            <a href="details.html">
                                ...
                                />
                                <div className="mt-2">
                                    <h3 className="text-light text-sm font-bold truncate">The Merry Gentlemen</h3>
                                    <p className="text-primary text-xs">2022</p>
                                </div>
                            </a>
                        </div>
                        ...
                        <div className="flex-shrink-0 w-48 cursor-pointer hover:scale-105 transition-transform">
                            <a href="details.html">
                                ...
                                />
                                <div className="mt-2">
                                    <h3 className="text-light text-sm font-bold truncate">Out of My Mind</h3>
                                    <p className="text-primary text-xs">2021</p>
                                </div>
                            </a>
                        </div>
